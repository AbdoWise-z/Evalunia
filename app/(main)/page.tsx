...
const LandingPage = () => {
  ...
  return (
    <div className="h-full flex flex-col mb-9">
      ...
      <div className='h-full'>
        <div
          ...
          <div className="p-4 max-w-6xl mx-auto relative z-10 w-full pt-20 md:pt-0 flex flex-col justify-center h-full">
            <h1
              className="text-9xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 to-neutral-950 dark:from-neutral-50 dark:to-neutral-400 bg-opacity-50 font-Rafgins">
              Welcome to Evalunia
            </h1>
            <p
              className="mt-4 font-normal text-2xl  text-neutral-950 dark:text-neutral-300 max-w-lg text-center mx-auto">
      ...
      <div className="">
        <div
          className="h-[30vh] rounded-md flex flex-col antialiased bg-white  dark:bg-[#171717] dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
          <InfiniteMovingCards
            items={testimonials}
            direction="right"
            speed="slow"
      ...
      <div className="mt-8">
        <h2
          className="text-5xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 to-neutral-950 dark:from-neutral-50 dark:to-neutral-400 bg-opacity-50 font-Rafgins">
          Our Mission
        </h2>
        <div
          ...
          <div className=''>
            <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
              ...
              <p className="text-xl text-neutral-600 text- dark:text-neutral-200">
                Our mission is to empower students and help them make informed decisions about their academic
                experience. We believe that the quality of instruction is a crucial factor in a {"student's"} success,
                and {"that's"} why {"we've"} created a platform where students can share their honest feedback and
                ratings on the professors {"they've"} encountered.
              </p>
