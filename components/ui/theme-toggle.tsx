  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className={"w-8 h-8 ml-0.5 border-[2px] border-transparent hover:dark:border-white hover:border-black mb-2 hover:dark:bg-white/10 rounded-full transition-all hover:bg-black/10"}>
