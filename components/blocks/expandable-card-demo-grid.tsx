...
const cards = [
  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
          In addition to numerical ratings, Evalunia encourages students to share detailed reviews of their experiences with professors. These reviews provide valuable insights into teaching styles, course content, and the overall classroom environment.
        </p>
      );
    },
  },
